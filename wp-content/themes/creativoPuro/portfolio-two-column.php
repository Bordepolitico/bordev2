                    ...
                    <div class="portfolio-wrapper <?php echo $grid; ?>">
                        ...
                        while($gallery->have_posts()): $gallery->the_post();
                        	...
                        	?>
                                ...
                                $thumb_link = wp_get_attachment_image_src(get_post_thumbnail_id(), 'portfolio-two');						
                                        ...
                                        <div class="project-feed clearfix">										
                                            <div class="ch-item portfolio-2">	
                                                <div class="ch-info portfolio-2">
                                                    <div class="ch-info-front2 "><img src="<?php echo $thumb_link[0]; ?>" /></div>
                                                    <div class="ch-info-back2 portfolio-2" style="background-image:url(<?php echo $thumb_link[0]; ?>);">
                                                        <?php 													
								...
								?>	
									<figure class="effect-zoe cols-2 <?php echo $item_classes; ?>">	
										<?php echo get_the_post_thumbnail($post->ID, 'portfolio-two');?>
