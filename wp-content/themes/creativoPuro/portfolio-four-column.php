                    ...
                    <div class="portfolio-wrapper <?php echo $grid; ?>">
                        ...
                        while($gallery->have_posts()): $gallery->the_post();
                            if(has_post_thumbnail() || get_post_meta($post->ID, 'pyre_youtube', true) || get_post_meta($post->ID, 'pyre_vimeo', true)):
								...
								$thumb_link = wp_get_attachment_image_src(get_post_thumbnail_id(), 'portfolio-four');
                                        ...
                                        <div class="project-feed clearfix">										
                                            <div class="ch-item portfolio-4">	
                                                <div class="ch-info portfolio-4">
                                                    ...
                                                    <div class="ch-info-back4 portfolio-4" style="background-image:url(<?php echo $thumb_link[0]; ?>);">
                                                        <?php 													
								...
								?>	
									<figure class="effect-zoe cols-4 <?php echo $item_classes; ?>">	
