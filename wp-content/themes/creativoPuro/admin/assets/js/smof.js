...
jQuery(document).ready(function($) {    
	...
	green['primary_color_hover'] = green['pb_hover_color'] = green['shortcode_color'] = green['footer_widget_link_color'] = green['contact_link_hover'] = green['menu_color_bg_hover'] = green['submenu_bg_color_hover'] = green['back_top_bg_hover'] = green['cta_bg'] = green['cta_button_background_color'] = green['button_background_color'] = green['button_border_color'] = green['action_bg'] = green['featured_serv_link'] = green['featured_serv_bg_hover'] = green['mm_links_color_hover'] = green['mm_column_title_hover'] = green['submenu_border_color'] ='#5bc98c';
	green['cta_bg_hover'] = green['cta_button_background_color_hover'] = green['button_background_color_hover'] = green['button_border_color_hover'] = green['action_bg_hover'] = '#479e85';
	
    var red = new Array();
	
	red['primary_color_hover'] = red['pb_hover_color'] = red['shortcode_color'] = red['footer_widget_link_color'] = red['contact_link_hover'] = red['menu_color_bg_hover'] = red['submenu_bg_color_hover'] = red['back_top_bg_hover'] = red['cta_bg'] = red['cta_button_background_color'] = red['button_background_color'] = red['button_border_color'] = red['action_bg'] = red['featured_serv_link'] = red['featured_serv_bg_hover'] = red['mm_column_title_hover'] = red['mm_links_color_hover'] = red['submenu_border_color'] ='#F6677B';
	red['cta_bg_hover'] = red['cta_button_background_color_hover'] = red['button_background_color_hover'] = red['button_border_color_hover'] = red['action_bg_hover'] = '#d05b6c';
		
    var blue = new Array();
	
	blue['primary_color_hover'] = blue['pb_hover_color'] = blue['shortcode_color'] = blue['footer_widget_link_color'] = blue['contact_link_hover'] = blue['menu_color_bg_hover'] = blue['submenu_bg_color_hover'] = blue['back_top_bg_hover'] = blue['cta_bg'] = blue['cta_button_background_color'] = blue['button_background_color'] = blue['button_border_color'] = blue['action_bg'] = blue['featured_serv_link'] = blue['featured_serv_bg_hover'] = blue['mm_column_title_hover'] = blue['mm_links_color_hover'] = blue['submenu_border_color'] ='#44b6df';
	blue['cta_bg_hover'] = blue['cta_button_background_color_hover'] = blue['button_background_color_hover'] = blue['button_border_color_hover'] = blue['action_bg_hover'] = '#368faf';
	
	var yellow = new Array();	
	
	yellow['primary_color_hover'] = yellow['pb_hover_color'] = yellow['shortcode_color'] = yellow['footer_widget_link_color'] = yellow['contact_link_hover'] = yellow['menu_color_bg_hover'] = yellow['submenu_bg_color_hover'] = yellow['back_top_bg_hover'] = yellow['cta_bg'] = yellow['cta_button_background_color'] = yellow['button_background_color'] = yellow['button_border_color'] = yellow['action_bg'] = yellow['featured_serv_link'] = yellow['featured_serv_bg_hover'] = yellow['mm_column_title_hover'] = yellow['mm_links_color_hover'] = yellow['submenu_border_color'] ='#febf4d';
	yellow['cta_bg_hover'] = yellow['cta_button_background_color_hover'] = yellow['button_background_color_hover'] = yellow['button_border_color_hover'] = yellow['action_bg_hover'] = '#d39119';
	
	var purple = new Array();
	
	purple['primary_color_hover'] = purple['pb_hover_color'] = purple['shortcode_color'] = purple['footer_widget_link_color'] = purple['contact_link_hover'] = purple['menu_color_bg_hover'] = purple['submenu_bg_color_hover'] = purple['back_top_bg_hover'] = purple['cta_bg'] = purple['cta_button_background_color'] = purple['button_background_color'] = purple['button_border_color'] = purple['action_bg'] = purple['featured_serv_link'] = purple['featured_serv_bg_hover'] = purple['mm_column_title_hover'] = purple['mm_links_color_hover'] = purple['submenu_border_color'] ='#ee79ba';
	purple['cta_bg_hover'] = purple['cta_button_background_color_hover'] = purple['button_background_color_hover'] = purple['button_border_color_hover'] = purple['action_bg_hover'] = '#c95b98';
	
	var grey = new Array();	
	
	grey['primary_color_hover'] = grey['pb_hover_color'] = grey['shortcode_color'] = grey['footer_widget_link_color'] = grey['contact_link_hover'] = grey['menu_color_bg_hover'] = grey['submenu_bg_color_hover'] = grey['back_top_bg_hover'] = grey['cta_bg'] = grey['cta_button_background_color'] = grey['button_background_color'] = grey['button_border_color'] = grey['action_bg'] = grey['featured_serv_link'] = grey['featured_serv_bg_hover'] = grey['mm_column_title_hover'] = grey['mm_links_color_hover'] = grey['submenu_border_color'] ='#a9a9a9';
	grey['cta_bg_hover'] = grey['cta_button_background_color_hover'] = grey['button_background_color_hover'] = grey['button_border_color_hover'] = grey['action_bg_hover'] = '#8b8a8a';	
	
	var black = new Array();
	
	black['primary_color_hover'] = black['pb_hover_color'] = black['shortcode_color'] = black['footer_widget_link_color'] = black['contact_link_hover'] = black['menu_color_bg_hover'] = black['submenu_bg_color_hover'] = black['back_top_bg_hover'] = black['cta_bg'] = black['cta_button_background_color'] = black['button_background_color'] = black['button_border_color'] = black['action_bg'] = black['featured_serv_link'] = black['featured_serv_bg_hover'] = black['mm_column_title_hover'] = black['mm_links_color_hover'] = black['submenu_border_color'] ='#5c5c5c';
	black['cta_bg_hover'] = black['cta_button_background_color_hover'] = black['button_background_color_hover'] = black['button_border_color_hover'] = black['action_bg_hover'] = '#2d2d2d';
